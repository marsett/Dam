...
public class ModeloDatos extends AbstractTableModel{
	...
	public void insertarFila() {
		...
		int tamTocados=tocados.length;
		Object[][] copia=new Object[tam+1][columnasTitulos.length];
		System.arraycopy(arrayDatos, 0, copia, 0, tam);
		this.arrayDatos=copia;
		boolean[][] copiaTocados=new boolean[tamTocados+1][columnasTitulos.length];
		System.arraycopy(tocados, 0, copiaTocados, 0, tamTocados);
		this.tocados=copiaTocados;
		arrayDatos[arrayDatos.length-1][0]=arrayDatos.length;
