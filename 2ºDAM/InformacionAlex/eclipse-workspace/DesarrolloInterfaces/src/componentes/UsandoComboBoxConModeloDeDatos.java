...
public class UsandoComboBoxConModeloDeDatos extends JFrame{
	...
	private class ModeloDatosPersonas extends AbstractListModel<Persona> implements ComboBoxModel<Persona>{
		Persona persona1=new Persona("Ramon","Mendoza","Garcia",89);
		Persona persona2=new Persona("Diego","Pablo","Siemone",50);
		Persona[] listaPersonas= {persona1,persona2};
		@Override
		public int getSize() {
			// TODO Auto-generated method stub
			return 0;
