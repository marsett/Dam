...
public class ClasePrincipal {
	public static void main(String[] args) throws IOException{
		...
		File directorioBin = new File("C:\\Users\\jimen\\eclipse-workspace\\Pruebas\\bin");
		int sumaTotal = 0;
		for(int i=0; i<3; i++) {
	...
	public void fichero(int suma) throws IOException{
		File result=new File("C:\\Users\\jimen\\eclipse-workspace\\Pruebas\\resultado.txt");
		result.createNewFile();
		FileWriter fw=new FileWriter(result);
		fw.write("La Suma Total es "+String.valueOf(suma));
		fw.close();
		ProcessBuilder pb=new ProcessBuilder();
		pb.command("notepad.exe","C:\\Users\\jimen\\eclipse-workspace\\Pruebas\\resultado.txt");
		pb.start();
	}
}
