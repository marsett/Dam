...
//los ataques deberían mostrar el tipo de ataque y el valor de este
//no se ve el resumen de las propiedades del jugador
//te falta la condición de último ataque por parte del usuario
  ...
  public static void main (String[] args) {
    ...
    do{
      ...
      if(salude < 50 && pocione > 0){
        salude+=50;
        //no entiendo la naturaleza de la concatenación
        ...
        //tiene más lógica sacar las condiciones de muerte fuera del while
        //de hecho, te faltaría también la opción de los dos muertos al mismo tiempo
